...
import kotlinx.android.synthetic.main.tuple_left_menu.view.*

class LeftMenuViewHolder(itemView: View, listener: AdapterClickListener) : BaseViewHolder<Category, AdapterClickListener>(itemView, listener) {
