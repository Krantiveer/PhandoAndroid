...
class HomeFragmentHorizontalListItemViewHolder(itemView: View, listener: AdapterClickListener, val imageOrientation: Int?=0) : BaseViewHolder<Video, AdapterClickListener>(itemView, listener) {
