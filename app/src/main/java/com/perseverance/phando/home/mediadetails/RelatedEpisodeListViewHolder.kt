...
class RelatedEpisodeListViewHolder(itemView: View, listener: AdapterClickListener) : BaseViewHolder<RelatedEpisode, AdapterClickListener>(itemView, listener) {
    ...
    override fun onBind(item: RelatedEpisode) {
        itemView.tag = item
        itemView.free.gone()
