...
public class AppDefaultTrackNameProvider implements TrackNameProvider {

  private final Resources resources;

  /** @param resources Resources from which to obtain strings. */
  public AppDefaultTrackNameProvider(Resources resources) {
  ...
  private String buildResolutionString(Format format) {
    ...
    return width == Format.NO_VALUE || height == Format.NO_VALUE
        ? ""
        : resources.getString(R.string.track_resolution, height);
  }
  ...
  private String buildBitrateString(Format format) {
    ...
    return bitrate == Format.NO_VALUE
        ? ""
        : resources.getString(R.string.track_bitrate, bitrate / 1000);
  }
